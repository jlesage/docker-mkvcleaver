...
This project provides a Docker container for [MKVCleaver](https://blogs.sapib.ca/apps/mkvcleaver/).
...
> [!NOTE]
> This Docker container is entirely unofficial and not made by the creators of MKVCleaver.
...
[Releases]: https://github.com/jlesage/docker-mkvcleaver/releases
[Docker Hub]: https://hub.docker.com/r/jlesage/mkvcleaver/tags
...
container, it would proxy all HTTP requests for `mkvcleaver.domain.tld` to
...
| **Application version** label | Displays the version of MKVCleaver integrated into Docker image. |
...
Any desktop notification generated by MKVCleaver is forwarded to the
